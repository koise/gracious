...
<head>
    ...
    <title>Gracious Smile Admin - Dashboard</title>
    @vite([
        // Partials
                    ...
                    <div class="content-body">
                        <div class="graphbox">
                            <div class="box">
                                <div>
                                    Appoinment Status:
                                    <select name="pieChartFilter" id="pieChartFilter">
                                        <option value="less_than_a_week" selected>Less than 7 days</option>
                                        <option value="less_than_a_month">Less than 30 days</option>
                            ...
                            <div class="box">
                                ...
                                <div>
                                    Total Appointments:
                                    <select name="lineChartFilter" id="lineChartFilter">
                                        <option value="less_than_a_week" selected>Less than 7 days</option>
                                        <option value="less_than_a_month">Less than 30 days</option>
                                        <option value="less_than_a_year">Less than a year</option>
                                    </select>
