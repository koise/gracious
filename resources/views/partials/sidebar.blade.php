<div class="sidebar" id="sidebar">
    <ul>
        ...
        <li>
            <a href="{{ route('admin.employee') }}" class="{{ Route::is('admin.employee') ? 'active' : '' }}"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                    fill="#e8eaed">
                    <path
        ...
        <li>
            ...
            <ul class="sub-menu">
                ...
                <li><a href="{{ route('admin.appointment') }}"  class="{{ Route::is('admin.appointment') ? 'active' : '' }}">Pending and List</a></li>
        ...
        <li>
            ...
            <ul class="sub-menu">
                ...
                <li><a href="{{ route('admin.patient.record') }}"  class="{{ Route::is('admin.patient.record') ? 'active' : '' }}">Orthodontic Treatment</a></li>
                <li><a href="{{ route('admin.authorization') }}"  class="{{ Route::is('admin.authorization') ? 'active' : '' }}">Authorization</a></li>
