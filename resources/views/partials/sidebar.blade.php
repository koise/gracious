<div class="sidebar" id="sidebar">
    <ul>
        ...
        @if (Auth::guard('admin')->check() && Auth::guard('admin')->user()->role == 'Admin')
            ...
            <li>
                <a href="{{ route('admin.employee') }}" class="{{ Route::is('admin.employee') ? 'active' : '' }}"><svg
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{ route('admin.appointments.pending') }}"
                            class="{{ Route::is('admin.appointments.pending') ? 'active' : '' }}">Pending and
                            Schedule</a>
                    </li>
                    <li><a href="{{ route('admin.appointments.list') }}"
                            class="{{ Route::is('admin.appointments.list') ? 'active' : '' }}">List</a></li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a href="{{ route('admin.payments') }}" class="{{ Route::is('admin.payments') ? 'active' : '' }}">Payments</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.qr') }}" class="{{ Route::is('admin.qr') ? 'active' : '' }}">QR Payments</a>
                    </li>
                </ul>
            </li>
            <li><a href="">
                    ...
                    <span>Logs</span></a></li>
        @elseif(Auth::guard('admin')->check() && Auth::guard('admin')->user()->role == 'Staff')
            <li>
                <button class="dropdown-btn">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#e8eaed">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="{{ route('staff.pending.appointment') }}">Pending Appointments</a></li>
                    <li><a href="{{ route('staff.appointment.list') }}">Appointment List</a></li>
            ...
            <li>
                <a href=" {{ route('staff.transaction') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"
                        fill="#e8eaed">
                        <path
        ...
        @elseif(Auth::guard('admin')->check() && Auth::guard('admin')->user()->role == 'Doctor')
        @endif
