...
<head>
    ...
    @vite(['resources/scss/user/userlogin.scss', 
            ...
            <div class="form-default">
                ...
                <div class="form-body">
                    <form id="loginForm" method="POST">
                        ...
                        <div class="form-group-col">
                            <span class="forgot-password"><a href="{{ route('user.forgot.password') }}">Forgot Password?</a></span>
    ...
    $('#loginForm').on('submit', function (e) {
        ...
        $.ajax({
            ...
            error: function (xhr) {
                ...
                let errorMessages = '<div class="form-group-col"><ul class="text-danger">';
