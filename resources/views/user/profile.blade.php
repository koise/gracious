...
<body>
    ...
    <div class="profile-container" style="justify-content:center; margin-top: 20%;">
        <div class="profile-card">
            <div class="profile-header">
                <h2 class="profile-name">Edgar Dollentas</h2>
                <p class="profile-username">@gahrie</p>
            </div>
    ...
    <div class="placeholder-text">Drag & Drop your ID image here or click to upload</div>
    ...
    <button type="submit" id="uploadBtn" style="display:none;">Upload ID</button>
    </div>
    </div>
    <!-- Upload Button -->
    <button id="uploadBtn" style="display:none;">Upload ID</button>
</body>
</html>
