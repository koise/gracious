...
<head>
    ...
    @vite(['resources/scss/user/userappointment.scss', 'resources/scss/usersidebar.scss', 'resources/scss/modal.scss', 'resources/scss/footer.scss', 'resources/js/user/appointment.js'])
    <style>
